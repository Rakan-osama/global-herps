            ...
            <div class="col-lg-6">
               <div class="why-txt">
                  <div class="sec-intro">
                     ...
                     <p>{{ __('Quality starts in the field and continues through every processing step until the product reaches the buyer. We offer complete traceability, consistent specifications, and reliable year-round supply.') }}</p>
                  </div>
