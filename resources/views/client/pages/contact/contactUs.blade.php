         ...
         <div class="row">
            <div class="col-lg-12">
               <div class="promo-wrap">
                  <h1 class="display-2 text-info">{{ __('Contact Us') }}</h1>
         ...
         <div class="row gy-4 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6">
               <div class="bg-white rounded-4 p-4 text-center shadow-sm h-100">
                  ...
                  <h5 class="fw-bold">{{ __('WhatsApp') }}</h5>
         ...
         <div class="row justify-content-center">
            <div class="col-lg-8">
               <div class="sec-intro text-center mb-5">
                  ...
                  <h2 class="">{{ __('Send Us a Message') }}</h2>
                     ...
                     <div class="row gy-4">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="full_name" name="full_name" class="form-control @error('full_name') is-invalid @enderror" placeholder="{{ __('Enter your full name') }}" value="{{ old('full_name') }}" required>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="{{ __('Enter your email') }}" value="{{ old('email') }}" required>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="tel" id="phone" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="{{ __('Enter your phone number') }}" value="{{ old('phone') }}" required>
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="country" name="country" class="form-control @error('country') is-invalid @enderror" placeholder="{{ __('Enter your country') }}" value="{{ old('country') }}" required>
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <select id="product_interest" name="service" class="form-control tv-select @error('service') is-invalid @enderror" required>
                                 ...
                                 <option value="mint"        {{ old('service') === 'mint'        ? 'selected' : '' }}>{{ __('Egyptian Mint') }}</option>
                                 <option value="chamomile"   {{ old('service') === 'chamomile'   ? 'selected' : '' }}>{{ __('Chamomile') }}</option>
                                 <option value="anise"       {{ old('service') === 'anise'       ? 'selected' : '' }}>{{ __('Anise Seeds') }}</option>
                                 <option value="fenugreek"   {{ old('service') === 'fenugreek'   ? 'selected' : '' }}>{{ __('Fenugreek') }}</option>
                                 <option value="coriander"   {{ old('service') === 'coriander'   ? 'selected' : '' }}>{{ __('Coriander') }}</option>
                                 <option value="other"       {{ old('service') === 'other'       ? 'selected' : '' }}>{{ __('Other') }}</option>
                              </select>
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" rows="5" placeholder="{{ __('Describe your requirements...') }}" required>{{ old('description') }}</textarea>
