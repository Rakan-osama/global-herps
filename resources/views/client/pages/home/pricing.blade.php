   ...
   <section class="pricing-sec position-relative bg-shade sec-padding">
      <img src="{{ asset('client/assets/images/pricing-sh1.png') }}" alt="" class="abs-img moveY bottom-0 start-0">
               ...
               <div class="pricing-content">
                  <div class="mb-4">
                     <span class="sub-title fadeInUp">
                        ...
                        Pricing Plan</span>
                     <h2 class="">Leading global logistic and transport agency</h2>
                     <p>With over four decades of experience providing solutions to large-scale enterprises throughout
                        the
                  ...
                  <div class="quick-call d-flex align-items-center">
                     <img src="{{ asset('client/assets/images/agent.png') }}" alt="agent">
               ...
               <div class="pricing-options ">
                  <div class="single-plan round border">
                     <div class="plan-head">
                        ...
                        <a href="{{ route('client.contact') }}" class="pricing-btn">Get Started <i class="fa fa-arrow-right"></i></a>
                     </div>
                     <div class="plan-body">
                        <ul>
