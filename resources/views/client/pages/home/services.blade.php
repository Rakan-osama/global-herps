          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="service-card bg-white round">
                ...
                <div class="service-thumb">
                  <img class="img-fluid" src="{{ asset('client/assets/images/herbs_images/spearmint.webp') }}" alt="" width="370" height="220" loading="lazy" decoding="async">
                </div>
            ...
            <div class="swiper-slide">
              <div class="service-card bg-white round">
                ...
                <div class="service-thumb">
                  <img class="img-fluid" src="{{ asset('client/assets/images/herbs_images/chamomile.webp') }}" alt="" width="370" height="220" loading="lazy" decoding="async">
                </div>
            ...
            <div class="swiper-slide">
              <div class="service-card bg-white round">
                ...
                <div class="service-thumb">
                  <img class="img-fluid" src="{{ asset('client/assets/images/seeds/anise_seeds.webp') }}" alt="" width="370" height="220" loading="lazy" decoding="async">
                </div>
            ...
            <div class="swiper-slide">
              <div class="service-card bg-white round">
                ...
                <div class="service-thumb">
                  <img class="img-fluid" src="{{ asset('client/assets/images/seeds/fenugreek.webp') }}" alt="" width="370" height="220" loading="lazy" decoding="async">
                </div>
            ...
            <div class="swiper-slide">
              <div class="service-card bg-white round">
                ...
                <div class="service-thumb">
                  <img class="img-fluid" src="{{ asset('client/assets/images/seeds/coriander.webp') }}" alt="" width="370" height="220" loading="lazy" decoding="async">
                </div>
