         ...
         <div class="d-sm-flex align-items-center justify-content-between">
            <div class="sec-intro">
               <span class="sub-title fadeInUp"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="18"
                  ...
                  </svg> {{ _($portfolioHeader?->subtitle ?? 'Our Exports') }}</span>
               <h2 class="" data-cms-field="title">{{ _($portfolioHeader?->title ?? 'Premium Agricultural Products') }}</h2>
            </div>
                  ...
                  <div class="swiper-wrapper">
                     ...
                     <div class="swiper-slide">
                        <div class="portfolio-card">
                           ...
                           <div class="portfolio-info">
                              <span>{{ _($pItem->subtitle ?? '') }}</span>
                              <h3 class="display-4"><a href="{{ route('client.project', $pItem->slug) }}">{{ _($pItem->title) }}</a></h3>
                           </div>
                        </div>
                     </div>
                     @empty
                     <div class="swiper-slide">
                        <div class="portfolio-card">
                           ...
                           <div class="portfolio-info">
                              <span>{{ _('Vegetables') }}</span>
                              <h3 class="display-4"><a href="{{ route('client.projects') }}">{{ _('Fresh Vegetables') }}</a></h3>
                           </div>
                        </div>
                     </div>
                     @endforelse
