      ...
      <div class="row">
         <div class="col-lg-6">
            <div class="about-media position-relative">
               <div class="about-m1">
                  <img class="round img-fluid" src="{{ asset('client/assets/images/2148923173.jpg') }}" alt="" style="width: 460px; height: 370px; object-fit: cover;">
               ...
               <div class="about-m2">
                  ...
                  <img class="img-fluid" src="{{ asset('client/assets/images/2148923181.jpg') }}" alt="" style="width: 250px; height: 370px; object-fit: cover;">
               </div>
            </div>
         </div>
         <div class="col-lg-6">
            <div class="about-content">
               <span class="sub-title fadeInUp">
                  ...
                  {{ _('Who We Are') }}</span>
               <h2>{{ _('Global Herbs — Egyptian Herbs, Spices & Seeds') }}</h2>
               <p>{{ _('Global Herbs is an Egyptian company specialized in growing, processing and exporting premium mint, herbs, spices and seeds to international markets with consistent quality and reliable service. We combine traditional agricultural know-how with controlled drying, cleaning and sorting.') }}</p>
               <div class="d-sm-flex gap-4 about-feat border-bottom">
                  ...
                  <div class="ab-item d-flex align-items-center gap-3">
                     ...
                     <h3 class="display-4">{{ _('Premium Herbs') }}</h3>
                  </div>
               </div>
               <ul class="check">
                  <li>{{ _('Focused on natural herbs, spices and seeds from selected Egyptian farms') }}</li>
                  <li>{{ _('Controlled drying, cleaning and sorting for export-grade quality') }}</li>
                  <li>{{ _('Long-term partner for importers, tea packers and spice brands worldwide') }}</li>
               </ul>
               <div class="d-sm-flex align-items-center about-footer gap-5 mt-5">
                  <a href="{{ route('client.about') }}" class="btn btn-primary">{{ _('Learn More') }} <i class="fa fa-arrow-right"></i><span></span></a>
