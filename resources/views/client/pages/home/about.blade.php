      ...
      <div class="row">
         <div class="col-lg-6">
            <div class="about-media position-relative">
               <div class="about-m1">
                  <img class="round img-fluid" src="{{ asset('client/assets/images/herbs/1.webp') }}" alt="" style="width: 460px; height: 370px; object-fit: cover;" width="460" height="370" loading="lazy" decoding="async">
               ...
               <div class="about-m2">
                  ...
                  <img class="img-fluid" src="{{ asset('client/assets/images/herbs/2.webp') }}" alt="" style="width: 250px; height: 370px; object-fit: cover;" width="250" height="370" loading="lazy" decoding="async">
               </div>
            </div>
         </div>
         <div class="col-lg-6">
